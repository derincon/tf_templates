...
output "is_appdb_peered" {
  value = var.appdb_vcn_peering
}
...
output "appdb_wls_local_peering_gateway_id" {
  value = join("",oci_core_local_peering_gateway.appdb_wls_local_peering_gateway.*.id)
}