...
output "InstanceShapes" {
  value = coalescelist(oci_core_instance.wls-atp-instance.*.shape, oci_core_instance.wls_no_jrf_instance.*.shape, oci_core_instance.wls_ocidb_instance.*.shape, oci_core_instance.wls_ocidb_peered_vcn_instance.*.shape, list(""))
}

output "AvailabilityDomains" {
  value = coalescelist(oci_core_instance.wls-atp-instance.*.availability_domain, oci_core_instance.wls_no_jrf_instance.*.availability_domain, oci_core_instance.wls_ocidb_instance.*.availability_domain, oci_core_instance.wls_ocidb_peered_vcn_instance.*.availability_domain, list(""))
}
