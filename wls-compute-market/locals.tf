...
locals {
  ...
  appdb_network_compartment_id = var.configure_app_db && !local.is_atp_appdb && var.appdb_network_compartment_id == "" ? local.appdb_compartment_id : var.appdb_network_compartment_id

  disable_infra_db_vcn_peering = var.wls_existing_vcn_id == "" ? false : var.disable_infra_db_vcn_peering
  ...
  disable_app_db_vcn_peering = var.wls_existing_vcn_id == "" ? false : var.disable_app_db_vcn_peering

  // Criteria for AppDB VCN Peering:
  // 1 is_vcn_peering=true then infraDB VCN != AppDB VCN and WLSVCN != AppDB VCN
  // 3. nonJRF + wls_VCN != AppDB VCN
  appdb_vcn_peering = var.configure_app_db && local.is_vcn_peering && !local.is_atp_appdb && var.appdb_existing_vcn_id != "" ? (var.ocidb_existing_vcn_id != var.appdb_existing_vcn_id) && (var.appdb_existing_vcn_id != var.wls_existing_vcn_id)  : local.is_atp_appdb || !var.configure_app_db ? false : var.appdb_existing_vcn_id != var.wls_existing_vcn_id
  //appdb_vcn_peering1 = var.configure_app_db  && var.appdb_dbsystem_id != "" ?  var.ocidb_existing_vcn_id != var.appdb_existing_vcn_id
  //appdb_vcn_peering = var.configure_app_db ? var.appdb_dbsystem_id != "" && ((var.ocidb_existing_vcn_id != var.appdb_existing_vcn_id) || (var.appdb_existing_vcn_id != var.wls_existing_vcn_id))  : false



  assign_weblogic_public_ip = var.assign_weblogic_public_ip && var.subnet_type == "Use Public Subnet" ? true : false

  bastion_subnet_cidr     = var.bastion_subnet_cidr == "" && var.wls_vcn_name != "" && ! local.assign_weblogic_public_ip ? local.is_vcn_peering ? "11.0.6.0/24" : "10.0.6.0/24" : var.bastion_subnet_cidr
  ...
  appdb_compartment_id    = var.appdb_compartment_id == "" ? local.network_compartment_id : var.appdb_compartment_id
  dns_instance_shape      = var.dns_instance_shape == "" ? var.instance_shape : var.dns_instance_shape
  appdb_instance_shape    = var.appdbdns_instance_shape == "" ? var.instance_shape : var.appdbdns_instance_shape
  ...
  wls_availability_domain      = var.wls_subnet_id == "" ? var.wls_availability_domain_name : local.ad_names[0]
  ...
  #defined user tags
  tag_0_defined = var.tag_0_key == "~!@#$%^&*()" && var.tag_0_key_value == "~!@#$%^&*()" ? false : true
  tag_1_defined = var.tag_1_key == "~!@#$%^&*()" && var.tag_1_key_value == "~!@#$%^&*()" ? false : true
  tag_2_defined = var.tag_2_key == "~!@#$%^&*()" && var.tag_2_key_value == "~!@#$%^&*()" ? false : true
  tag_3_defined = var.tag_3_key == "~!@#$%^&*()" && var.tag_3_key_value == "~!@#$%^&*()" ? false : true
  tag_4_defined = var.tag_4_key == "~!@#$%^&*()" && var.tag_4_key_value == "~!@#$%^&*()" ? false : true
  tag_5_defined = var.tag_5_key == "~!@#$%^&*()" && var.tag_5_key_value == "~!@#$%^&*()" ? false : true
  tag_6_defined = var.tag_6_key == "~!@#$%^&*()" && var.tag_6_key_value == "~!@#$%^&*()" ? false : true
  tag_7_defined = var.tag_7_key == "~!@#$%^&*()" && var.tag_7_key_value == "~!@#$%^&*()" ? false : true
  tag_8_defined = var.tag_8_key == "~!@#$%^&*()" && var.tag_8_key_value == "~!@#$%^&*()" ? false : true
  tag_9_defined = var.tag_9_key == "~!@#$%^&*()" && var.tag_9_key_value == "~!@#$%^&*()" ? false : true

  tag_0_key           = false == local.tag_0_defined ? "" : var.tag_0_key
  tag_0_key_value     = false == local.tag_0_defined ? "" : var.tag_0_key_value
  tag_1_key           = false == local.tag_1_defined ? "" : var.tag_1_key
  tag_1_key_value     = false == local.tag_1_defined ? "" : var.tag_1_key_value
  tag_2_key           = false == local.tag_2_defined ? "" : var.tag_2_key
  tag_2_key_value     = false == local.tag_2_defined ? "" : var.tag_2_key_value
  tag_3_key           = false == local.tag_3_defined ? "" : var.tag_3_key
  tag_3_key_value     = false == local.tag_3_defined ? "" : var.tag_3_key_value
  tag_4_key           = false == local.tag_4_defined ? "" : var.tag_4_key
  tag_4_key_value     = false == local.tag_4_defined ? "" : var.tag_4_key_value
  tag_5_key           = false == local.tag_5_defined ? "" : var.tag_5_key
  tag_5_key_value     = false == local.tag_5_defined ? "" : var.tag_5_key_value
  tag_6_key           = false == local.tag_6_defined ? "" : var.tag_6_key
  tag_6_key_value     = false == local.tag_6_defined ? "" : var.tag_6_key_value
  tag_7_key           = false == local.tag_7_defined ? "" : var.tag_7_key
  tag_7_key_value     = false == local.tag_7_defined ? "" : var.tag_7_key_value
  tag_8_key           = false == local.tag_8_defined ? "" : var.tag_8_key
  tag_8_key_value     = false == local.tag_8_defined ? "" : var.tag_8_key_value
  tag_9_key           = false == local.tag_9_defined ? "" : var.tag_9_key
  tag_9_key_value     = false == local.tag_9_defined ? "" : var.tag_9_key_value
